    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-10 main-content">
                ...
                <div class="header">
                    <h1>➕ Tambah Siswa</h1>
                    <div class="subtitle">Isi form untuk menambahkan siswa baru</div>
                </div>
                    ...
                    <form action="{{ route('admin.siswa.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            @error('password')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <small class="text-muted">Gunakan password yang kuat dan mudah diingat siswa</small>
                        </div>
                ...
                <div class="text-center text-muted mt-3">
                    <small>
                        Form Tambah Siswa | Diperbarui: {{ now()->format('d/m/Y H:i') }}
                    </small>
                </div>
            </div>
        </div>
